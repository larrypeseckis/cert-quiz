window.QUESTIONS = [
  ...
  },
  {
    ...
    "options": ["Protecting society and the common good", "Acting honorably, honestly, and lawfully", "Disclosing client vulnerabilities publicly without authorization", "Advancing and protecting the profession"],
    "answer": 2,
  ...
  },
  {
    ...
    "options": ["Policy", "Standard", "Procedure", "Baseline"],
    "answer": 2,
  ...
  },
  {
    ...
    "options": ["Need to know", "Separation of duties", "Least privilege", "Defense in depth"],
    "answer": 2,
  ...
  },
  {
    ...
    "options": ["Least privilege", "Separation of duties", "Mandatory vacation", "Background check"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Job rotation", "Dual control (two-person integrity)", "Mandatory vacation", "Least privilege"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["It improves employee morale", "It allows fraudulent activity to be detected when another employee covers the role", "It reduces salaries", "It prevents burnout only"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Cross-training", "Detecting fraud and reducing dependence on a single person", "Boosting productivity", "Speeding up promotions"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Comply with marketing requirements", "Change user behavior so they recognize and respond appropriately to threats", "Replace technical controls", "Document policies"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Training builds specific skills; awareness focuses on changing attitudes and recognition of threats", "Training is online only; awareness is in person", "They are identical", "Awareness is required quarterly; training annually"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["Non-disclosure agreement (NDA)", "Acceptable Use Policy (AUP)", "Service Level Agreement (SLA)", "Memorandum of Understanding (MOU)"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Assigning labels (e.g., public, internal, confidential) based on value and sensitivity to drive handling requirements", "Storing assets in physical drawers", "Encrypting all assets equally", "Listing assets in a CMDB"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["Manage backups", "Define data classification and approve access to the data they own", "Apply patches", "Configure firewalls"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Data owner", "Data custodian", "Data user", "Data subject"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Increase paperwork", "Ensure changes are reviewed, tested, approved, and documented to minimize disruption and risk", "Make changes faster without oversight", "Replace configuration management"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Securely disposing of media", "Identifying, recording, and controlling the state of system components over their lifecycle", "Patching the OS", "Encrypting backups"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Guideline", "Baseline", "Procedure", "Standard"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Bollard", "Mantrap (interlocking door)", "Turnstile", "Security camera"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Reduce training budget", "Communicate policies, expected behaviors, reporting channels, and consequences from day one", "Replace background checks", "Reduce headcount"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Sealed juvenile records", "Identity verification and criminal history checks consistent with role and law", "DNA testing", "Polygraph for all roles"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Long passwords", "A formal de-provisioning process tied to HR offboarding, with prompt account disabling and access removal", "Annual password rotation", "Security cameras at workstations"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Fence", "Motion-sensitive alarms and CCTV with recording", "Sign on door", "Locked drawer"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Water sprinklers everywhere", "Clean agent (e.g., FM-200, Novec 1230) systems that do not damage electronics", "Foam", "Sand buckets"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["A specific configuration setting", "A high-level statement of what the control is intended to achieve", "A SLA metric", "A vendor SKU"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Implementing a single strong control", "Layering multiple controls so failure of one does not compromise the system", "Encrypting all traffic", "Hiding the architecture"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Technical (logical)", "Physical", "Administrative", "Compensating"],
    "answer": 2,
  ...
  },
  {
    ...
    "options": ["Administrative", "Technical (logical)", "Physical", "Operational"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["A control that adds redundancy", "An alternative control that meets the intent of a required control when the primary control cannot be implemented", "A control that compensates the security team financially", "A control that has been disabled"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Keep everything forever", "Define how long records are kept and when they are destroyed, balancing legal, regulatory, and business needs", "Increase storage costs", "Replace backups"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Format the drive", "Cryptographic erasure or physical destruction (shredding) per organizational standards", "Delete files using OS delete command", "Reformat and donate"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Encrypting the data", "Marking data with its classification to drive consistent handling", "Compressing the data", "Hashing the data"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Buy more storage", "Inventory the assets to be managed", "Set up logging", "Apply encryption"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Identification", "Authentication", "Authorization", "Accountability"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Authentication", "Accountability (auditing)", "Authorization", "Availability"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Password and security question", "Password and a one-time code from a hardware token", "Two passwords", "Username and password"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["False Rejection Rate (FRR / Type I)", "False Acceptance Rate (FAR / Type II)", "Crossover Error Rate (CER)", "Throughput rate"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Less accurate", "More accurate", "Slower", "More expensive only"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["TACACS+", "RADIUS", "Kerberos", "LDAP"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["RADIUS encrypts the entire packet; TACACS+ encrypts only the password", "TACACS+ encrypts the entire payload and separates AAA functions; RADIUS encrypts only the password and combines authentication/authorization", "They are identical", "RADIUS uses TCP; TACACS+ uses UDP"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["SAML 2.0", "OAuth 2.0", "RADIUS", "TACACS+"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["LDAP", "OAuth 2.0", "Kerberos", "RADIUS"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["SAML", "OpenID Connect (OIDC)", "RADIUS", "Kerberos"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Rule-Based Access Control (RuBAC)", "DAC", "MAC", "RBAC"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["They are too long", "Susceptible to guessing, phishing, reuse, and credential stuffing", "Inability to be encrypted", "They cannot be revoked"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Plaintext", "Hashed with a fast hash like MD5", "Hashed with a slow, salted algorithm such as bcrypt, scrypt, Argon2, or PBKDF2", "Encrypted with a single global key"],
    "answer": 2,
  ...
  },
  {
    ...
    "options": ["Use a regular user's credentials", "Use dedicated accounts with least privilege, restricted interactive login, rotated credentials, and stored in a secrets vault", "Share credentials between teams via email", "Embed credentials in source code"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["A single system controls all logins", "Trust relationships between identity providers allow users authenticated in one domain to access resources in another", "Identity is determined by IP address", "Only on-premises AD is used"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Confirm users still have only the access they need for their current role", "Issue new passwords", "Replace MFA", "Increase access by default"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["A spam filter", "A solution that vaults, rotates, and brokers access to privileged credentials with auditing and approval", "A web application firewall", "A SIEM"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Increase TLS cipher strength", "Enforce account lockout, throttling, and MFA", "Require longer URLs", "Disable HTTPS"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Slow down legitimate users", "Mitigate online password guessing attacks", "Reduce login speed during peak hours", "Enable SSO"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Each app has its own account", "A user authenticates once and gains access to multiple applications without re-entering credentials", "Passwords must be reused across apps", "MFA is bypassed"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Better user experience", "A compromised SSO credential grants access to many systems at once", "Higher infrastructure cost", "Bigger logs"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Permanent admin access for selected staff", "Temporary, time-bound privileges granted on demand and automatically revoked", "A new authentication factor", "A type of MFA"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Need to know", "Separation of duties", "Dual control", "Mandatory vacation"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["HOTP", "TOTP", "Smart card", "Biometric"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["HOTP is event-based (counter); TOTP is time-based", "HOTP is time-based; TOTP is event-based", "There is no difference", "HOTP uses SMS"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["FIDO2 is easier to phish", "FIDO2 uses public-key cryptography bound to the origin, resisting phishing and SIM-swap attacks", "SMS is hardware-backed", "FIDO2 requires no devices"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Access Control List", "Capability List", "Access Control Matrix", "Role Matrix"],
    "answer": 2,
  ...
  },
  {
    ...
    "options": ["Firewall rules listing allowed/denied source-destination pairs per port", "User passwords", "Backup schedule", "Account name format"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["Eliminates the need for HR", "Consistent, auditable, and timely creation/modification/removal of accounts across systems", "Removes need for monitoring", "Disables MFA"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["FIDO2 security key", "TOTP entered into a website", "Username and password", "Biometric on the device"],
    "answer": 2,
  ...
  },
  {
    ...
    "options": ["A potential cause of an incident", "A weakness in a system, process, or control that could be exploited", "An attacker's tool", "A risk treatment"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Existing damage to a system", "A potential cause of an unwanted incident, such as a hacker, malware, or natural event", "An installed control", "A residual risk"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Qualitative", "Quantitative", "Subjective", "Heuristic"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Risk acceptance", "Risk transference", "Risk avoidance", "Risk mitigation"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Risk mitigation", "Risk acceptance", "Risk avoidance", "Risk transference"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["Risk register", "Audit log", "Configuration baseline", "Asset list"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["Exploit systems", "Identify known weaknesses across systems via automated checks", "Replace patch management", "Manage user identities"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["They are the same", "Vulnerability scans identify weaknesses; penetration tests attempt to exploit them to demonstrate impact", "Pen tests are only automated", "Vulnerability scans are illegal"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Recent backups", "Written authorization defining scope, rules of engagement, and objectives", "Use of a specific tool", "Use of a specific operating system"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Black box", "White box", "Gray box", "Crystal box only"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["White box", "Gray box", "Black box", "Open box"],
    "answer": 2,
  ...
  },
  {
    ...
    "options": ["Scan once a year", "Continuous discovery, risk-based prioritization, remediation, and verification", "Disable patching to maintain stability", "Ignore false positives"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["CVSS (Common Vulnerability Scoring System)", "CVE", "CWE", "CCE"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["Common Vulnerability Estimator", "Critical Vulnerability Enumerator", "Common Vulnerabilities and Exposures", "Cyber Vulnerability Examiner"],
    "answer": 2,
  ...
  },
  {
    ...
    "options": ["Fill up disk space", "Create an audit trail for accountability, investigation, and detection", "Replace MFA", "Eliminate the need for backups"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["All security-relevant logs forwarded to a separate, write-protected log management or SIEM system", "Local logs only", "No logs", "Audit log printed on paper"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["KPI", "KRI", "Indicator of compromise (IOC)", "Patch"],
    "answer": 2,
  ...
  },
  {
    ...
    "options": ["A metric used to track the current level of risk in a particular area", "A measure of operational success", "A type of malware", "A vulnerability score"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["A backup system", "A platform that aggregates, correlates, and analyzes security events from many sources to produce alerts and dashboards", "A web application firewall", "An endpoint antivirus"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Signature-based detection", "Anomaly-based detection", "Allow-list filtering", "Hash matching"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Signature-based detection", "Anomaly-based detection", "Statistical analysis", "Honeypot deployment"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["Monthly audits", "Ongoing observation of security-relevant data and controls to maintain awareness and respond quickly", "Annual penetration test", "Reading reports once a year"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Hardened configuration only", "A measured set of normal operational metrics against which future observations are compared", "An initial backup", "An ACL"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Increased license cost", "Alert fatigue causing analysts to miss real incidents", "Slow network", "Higher RPO"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Wait for an incident", "Define what success looks like (metrics, baselines) and document risk addressed", "Disable monitoring", "Remove documentation"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Internal audit", "External black-box penetration test", "Code review", "Tabletop"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Fix critical first by CVSS only", "Combine severity, exploitability, asset criticality, and exposure (e.g., internet-facing) when prioritizing", "Fix oldest first regardless of severity", "Ignore CVSS"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Anti-virus signatures only", "Curated information about adversaries, their tools, techniques, and indicators, used to improve detections and decisions", "A type of firewall", "A patch"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Hope for the best", "Periodic control testing, audits, and security assessments", "Disable controls", "Defer to vendor confidence"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Detection & Analysis", "Preparation", "Containment", "Post-Incident Activity"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Detection", "Containment", "Recovery", "Lessons learned"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Assign blame", "Identify improvements to controls, processes, and the response itself, and update documentation", "Pay invoices", "Decommission systems"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Logical and irrelevant", "A guideline to collect the most volatile evidence (e.g., RAM, running processes) before less volatile (e.g., disk, archives)", "An order to disable network first", "An order to call lawyers first"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["The path of an attacker through the network", "Documentation tracking who handled evidence, when, and what they did, to preserve admissibility and integrity", "A list of vulnerabilities", "Insurance documentation"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Encryption with AES", "Hashing the image at acquisition and verifying the hash at each subsequent use", "Compressing the image", "Renaming the file"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Encrypting evidence", "The systematic identification, collection, preservation, analysis, and presentation of digital evidence", "Patching systems", "Performing user training"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Faster imaging", "Prevent any modification of the source media during imaging to preserve evidence integrity", "Compress data", "Encrypt during imaging"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Disaster Recovery Plan", "Business Continuity Plan", "Incident Response Plan", "Change Management Plan"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Disaster Recovery Plan (DRP)", "Business Continuity Plan (BCP)", "Incident Response Plan (IRP)", "Acceptable Use Policy (AUP)"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["BIA (Business Impact Analysis)", "Risk Assessment", "Vulnerability Scan", "Audit"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["MTD (Maximum Tolerable Downtime)", "RPO", "MTBF", "WRT"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["WRT (Work Recovery Time)", "RTO", "RPO", "MTD"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["Full backup", "Incremental backup", "Differential backup", "Snapshot only"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["Hot site", "Warm site", "Cold site", "Reciprocal site"],
    "answer": 2,
  ...
  },
  {
    ...
    "options": ["Tabletop / walkthrough", "Simulation", "Parallel", "Full interruption"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["Walkthrough", "Simulation", "Parallel test", "Full interruption"],
    "answer": 3,
  ...
  },
  {
    ...
    "options": ["A successful business outcome", "A confirmed or suspected violation of security policy or imminent threat thereof", "A scheduled change", "A user complaint"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["CSIRT / IRT", "Sales team", "Finance team", "External auditors"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["Punish staff", "Identify gaps and improvements in controls, detection, response, and communication", "End the project", "Increase headcount"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["They are required by law", "Allow consistent, accurate communications during high-stress situations and reduce delays", "Replace press releases entirely", "Eliminate the need to involve legal"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["The evidence may be inadmissible or unreliable, undermining legal action and root-cause analysis", "The firewall may stop working", "Backups will fail", "Logs become smaller"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["Backups stored on the same file share", "Offline, air-gapped, or immutable backups", "Hourly local snapshots only", "Daily local incremental backups"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Don't change anything in production", "Regularly test restorations and conduct BCP/DRP exercises", "Reduce backup frequency", "Encrypt backups twice"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Reissue user IDs", "Restoring affected systems to known-good state, validating, and returning them to normal operations with monitoring in place", "Adding new firewalls", "Sending email"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Reboot immediately to refresh memory", "Isolate the system from the network but preserve power and state for forensic acquisition, per the documented playbook", "Format the drive", "Apply patches and continue using"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Symmetric", "Asymmetric", "Hashing", "Steganographic"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["Pre-image resistance", "Collision resistance", "Reversibility", "Determinism"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Confidentiality only", "Authentication, integrity, and non-repudiation", "Faster encryption", "Compression"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["The signer's private key", "The signer's public key", "The receiver's private key", "A symmetric session key"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Distribute symmetric keys via email", "Issue, manage, and revoke digital certificates that bind public keys to identities, providing trust", "Encrypt data at rest", "Replace passwords"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Registration Authority (RA)", "Certificate Authority (CA)", "Validation Authority (VA)", "End Entity"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["CRL only", "OCSP (Online Certificate Status Protocol)", "DNSSEC", "X.500 directory"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["CRL (Certificate Revocation List)", "OCSP response", "CSR", "PKCS#12 archive"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["A copy of keys held by a trusted third party so they can be recovered under defined circumstances", "Encrypting keys with another key", "Storing keys on a USB drive", "Destroying keys at end of life"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["AH (Authentication Header)", "ESP (Encapsulating Security Payload)", "ISAKMP", "IKE"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["An IP-layer encryption protocol", "A protocol that provides confidentiality, integrity, and authentication for application data over TCP, widely used to secure HTTP", "A type of firewall", "A backup protocol"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Secure file transfer", "Provide encryption and digital signing for email messages using X.509 certificates", "Authenticate to web servers", "Sign software"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Known plaintext", "Chosen ciphertext", "Side-channel attack", "Birthday attack"],
    "answer": 2,
  ...
  },
  {
    ...
    "options": ["It shortens the ciphertext", "It ensures that identical plaintexts encrypt to different ciphertexts, preventing pattern analysis", "It speeds up encryption", "It compresses data"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["DNS poisoning", "ARP poisoning / spoofing", "TCP SYN flood", "Smurf attack"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Replay", "Smurf", "Cross-site scripting", "ARP poisoning"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["Stateless packet filter", "Stateful inspection firewall", "Application proxy", "Web application firewall"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Stateful", "Stateless packet filter", "Application proxy", "NGFW"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Stateless filter", "Stateful firewall", "Proxy / application-layer firewall", "Layer-2 filter"],
    "answer": 2,
  ...
  },
  {
    ...
    "options": ["Stateful inspection", "Application identification / awareness", "DHCP relay", "STP"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["IDS prevents; IPS detects", "IDS detects and alerts; IPS detects and actively blocks", "There is no difference", "IPS is host-only; IDS is network-only"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["TLS VPN", "IPsec VPN", "PPTP", "L2TP without IPsec"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["A type of VPN", "A logical segmentation of a switched network into separate broadcast domains", "A wireless mode", "A storage protocol"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Disable DHCP", "Implement 802.1X / NAC to authenticate devices before granting network access", "Use static IPs", "Block all multicast"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["A trusted internal LAN", "A buffer zone hosting public-facing services, separated from the internal network by firewalls", "A wireless network", "A backup site"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["WAF", "Sandbox", "Honeypot", "Bastion host"],
    "answer": 2,
  ...
  },
  {
    ...
    "options": ["DDoS", "Man-in-the-middle (MITM)", "Buffer overflow", "Phishing"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Use TLS with strong certificates and verify them; enforce HSTS", "Disable HTTPS", "Use HTTP instead", "Use longer passwords only"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["SPF", "DKIM", "DMARC", "STARTTLS"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["DMARC", "DNSSEC", "STARTTLS", "TLS-RPT"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["Use of a single network for everything", "Dividing a network into zones with controls between them to limit the spread of attacks", "Disabling Wi-Fi", "Using only IPv6"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["DNS poisoning", "ARP spoofing", "SYN flood", "Smurf attack"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["Bluejacking", "Bluesnarfing", "Bluebugging", "Bluesmacking"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["Bluejacking", "Bluesnarfing", "Bluebugging", "BlueBorne"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["A storage server", "A hardened intermediary that administrators must traverse to reach internal systems, enabling logging and control", "A backup target", "A DNS resolver"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Telnet", "FTPS or SFTP (SSH-based)", "TFTP", "Echo"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Trust everything inside the corporate network", "Treat all networks as untrusted and authenticate/authorize every request explicitly", "Eliminate firewalls", "Allow only IPv6"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["802.1X port authentication and rogue AP detection", "Hide the SSID only", "Use longer passwords on Wi-Fi", "Disable IPv6"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["Use SSL only", "Enable SYN cookies and use upstream DDoS protection / rate limiting", "Disable TCP", "Block all UDP"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Virus", "Worm", "Rootkit", "Adware"],
    "answer": 2,
  ...
  },
  {
    ...
    "options": ["Encrypts user data", "Collects information about user activity without their knowledge", "Generates ad impressions", "Locks the screen with a ransom note"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Speed them up", "Execute them in an isolated environment to safely observe their behavior", "Increase efficiency", "Replace antivirus"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Antivirus only", "EDR (Endpoint Detection and Response)", "DLP", "WAF"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["SQL injection", "Cross-Site Scripting (XSS)", "CSRF", "SSRF"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["XSS", "CSRF (Cross-Site Request Forgery)", "SQL injection", "Buffer overflow"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Parameterized queries / prepared statements", "Long passwords", "TLS", "Antivirus"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["Buffer overflow", "XSS", "CSRF", "Logic flaw"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["Input validation and contextual output encoding", "Use of plaintext protocols", "Disable logging", "Avoid testing"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["A list of programming languages to avoid", "Documented rules for writing code that minimizes common security defects", "Encryption requirements", "Patch schedule"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Painting the server", "Reducing the attack surface by removing unnecessary services, applying secure configurations, and applying baselines (e.g., CIS Benchmarks)", "Replacing the OS yearly", "Encrypting only certain files"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["DAST", "SAST", "IAST", "Fuzzing"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["SAST", "DAST", "Code review", "Threat modeling"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["A code style review", "Feeding random or malformed inputs to a program to find crashes or unexpected behavior", "Encrypting test data", "Generating user manuals"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["GPS tagging", "Remote wipe", "Screen mirroring", "Push notification"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Higher device cost", "Mixing of personal and corporate data, with reduced organizational control over device security posture", "Better performance", "More frequent updates"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Containerization / Mobile Application Management (MAM)", "VLAN trunking", "DNSSEC", "WAF"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["Air conditioning", "Hypervisor security, VM isolation, snapshot management, and VM sprawl", "Backup tape rotation", "Cable management"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["A storage volume", "A lightweight, isolated unit of software packaging that shares the host OS kernel", "A virtual machine with a separate kernel", "A network appliance"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["More heat output", "Shared kernel means a kernel-level compromise can affect all containers on the host", "Smaller storage", "Longer boot times"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Sign images and verify signatures at deployment, scan for vulnerabilities, use trusted registries", "Use the largest possible image", "Don't update base images", "Use only Windows containers"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["Reduce the number of users", "Configure systems to provide only the essential capabilities needed; disable unnecessary services and ports", "Reduce documentation", "Slow CPU speeds"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Better laptop cases", "Full-disk encryption combined with strong pre-boot authentication", "Anti-virus only", "Lighter laptops"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["IoT security: segmentation, credential management, firmware updates, and monitoring", "Use only Wi-Fi", "Avoid encryption", "Use only USB"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["The minimum set of secure configurations applied consistently to systems of the same type", "An emergency backup", "An ACL", "A patch"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["Compress executables", "Provide integrity and authenticity assurance of software, so users can verify it has not been altered and comes from the stated publisher", "Encrypt data files", "Replace certificates"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["A type of physical bomb", "Malicious code that triggers when specific conditions are met (date, event, action)", "A patch", "A firewall rule"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["A type of antivirus", "A sustained, often state-sponsored adversary that maintains long-term, stealthy access to gather intelligence or position for impact", "A SIEM module", "A backup category"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Configuring a SIEM", "Manipulating people into performing actions or divulging information by exploiting trust, authority, urgency, or fear", "Patching servers", "Backing up data"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Stronger passwords alone", "Phishing-resistant MFA (e.g., FIDO2) combined with awareness training and email filtering", "Disable email", "Use HTTP"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Applications should run with maximum admin rights", "Applications should run with only the privileges they actually need to perform their functions", "Applications should run as root for stability", "Applications should not authenticate"],
    "answer": 1,
